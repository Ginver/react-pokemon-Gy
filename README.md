...
![Pokémon logo](src/assets/logo.png)
...
6. Maak twee knoppen met allebei hun eigen `clickHandler` functie. Wanneer de gebruiker op 'volgende' klikt, willen we een nieuw request doen naar een nieuw endpoint. 
Bekijk de documentatie voor het ophalen van een lijst van pokémons nog eens goed. We willen dat het ophalen van data getriggerd wordt, wanneer het endpoint wordt veranderd.